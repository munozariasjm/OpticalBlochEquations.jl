...
function condition(u,t,integrator)
    ...
    r = sqrt(r)
    if r >= 4e-3*k # terminate if the particle is more than 3 mm from the centre
...
function make_problem_with_param(molecule_package, param)    
    ...
    k̂ = +x̂; ϵ1 = ϕs[1]*rotate_pol(pol1_x, k̂); ϵ_func1 = ϵ_(ϵ1, 1); laser1 = Field(k̂, ϵ_func1, ω1, s_func(s1x))
    k̂ = -x̂; ϵ2 = ϕs[2]*rotate_pol(pol1_x, k̂); ϵ_func2 = ϵ_(ϵ2, 2); laser2 = Field(k̂, ϵ_func2, ω1, s_func(s1x))
    k̂ = +ŷ; ϵ3 = ϕs[3]*rotate_pol(pol1_x, k̂); ϵ_func3 = ϵ_(ϵ3, 3); laser3 = Field(k̂, ϵ_func3, ω1, s_func(s1y))
    k̂ = -ŷ; ϵ4 = ϕs[4]*rotate_pol(pol1_x, k̂); ϵ_func4 = ϵ_(ϵ4, 4); laser4 = Field(k̂, ϵ_func4, ω1, s_func(s1y))
    k̂ = +ẑ; ϵ5 = ϕs[5]*rotate_pol(flip(pol1_x), k̂); ϵ_func5 = ϵ_(ϵ5, 5); laser5 = Field(k̂, ϵ_func5, ω1, s_func(s1z))
    k̂ = -ẑ; ϵ6 = ϕs[6]*rotate_pol(flip(pol1_x), k̂); ϵ_func6 = ϵ_(ϵ6, 6); laser6 = Field(k̂, ϵ_func6, ω1, s_func(s1z))
    ...
    k̂ = +x̂; ϵ7 = ϕs[1]*rotate_pol(pol2_x, k̂); ϵ_func7 = ϵ_(ϵ7, 1); laser7 = Field(k̂, ϵ_func7, ω2, s_func(s2x))
    k̂ = -x̂; ϵ8 = ϕs[2]*rotate_pol(pol2_x, k̂); ϵ_func8 = ϵ_(ϵ8, 2); laser8 = Field(k̂, ϵ_func8, ω2, s_func(s2x))
    k̂ = +ŷ; ϵ9 = ϕs[3]*rotate_pol(pol2_x, k̂); ϵ_func9 = ϵ_(ϵ9, 3); laser9 = Field(k̂, ϵ_func9, ω2, s_func(s2y))
    k̂ = -ŷ; ϵ10 = ϕs[4]*rotate_pol(pol2_x, k̂); ϵ_func10 = ϵ_(ϵ10, 4); laser10 = Field(k̂, ϵ_func10, ω2, s_func(s2y))
    k̂ = +ẑ; ϵ11 = ϕs[5]*rotate_pol(flip(pol2_x), k̂); ϵ_func11 = ϵ_(ϵ11, 5); laser11 = Field(k̂, ϵ_func11, ω2, s_func(s2z))
    k̂ = -ẑ; ϵ12 = ϕs[6]*rotate_pol(flip(pol2_x), k̂); ϵ_func12 = ϵ_(ϵ12, 6); laser12 = Field(k̂, ϵ_func12, ω2, s_func(s2z))
    ...
    k̂ = +x̂; ϵ13 = ϕs[1]*rotate_pol(pol3_x, k̂); ϵ_func13 = ϵ_(ϵ13, 1); laser13 = Field(k̂, ϵ_func13, ω3, s_func(s3x))
    k̂ = -x̂; ϵ14 = ϕs[2]*rotate_pol(pol3_x, k̂); ϵ_func14 = ϵ_(ϵ14, 2); laser14 = Field(k̂, ϵ_func14, ω3, s_func(s3x))
    k̂ = +ŷ; ϵ15 = ϕs[3]*rotate_pol(pol3_x, k̂); ϵ_func15 = ϵ_(ϵ15, 3); laser15 = Field(k̂, ϵ_func15, ω3, s_func(s3y))
    k̂ = -ŷ; ϵ16 = ϕs[4]*rotate_pol(pol3_x, k̂); ϵ_func16 = ϵ_(ϵ16, 4); laser16 = Field(k̂, ϵ_func16, ω3, s_func(s3y))
    k̂ = +ẑ; ϵ17 = ϕs[5]*rotate_pol(flip(pol3_x), k̂); ϵ_func17 = ϵ_(ϵ17, 5); laser17 = Field(k̂, ϵ_func17, ω3, s_func(s3z))
    k̂ = -ẑ; ϵ18 = ϕs[6]*rotate_pol(flip(pol3_x), k̂); ϵ_func18 = ϵ_(ϵ18, 6); laser18 = Field(k̂, ϵ_func18, ω3, s_func(s3z))
    ...
    k̂ = +x̂; ϵ19 = ϕs[1]*rotate_pol(pol4_x, k̂); ϵ_func19 = ϵ_(ϵ19, 1); laser19 = Field(k̂, ϵ_func19, ω4, s_func(s4x))
    k̂ = -x̂; ϵ20 = ϕs[2]*rotate_pol(pol4_x, k̂); ϵ_func20 = ϵ_(ϵ20, 2); laser20 = Field(k̂, ϵ_func20, ω4, s_func(s4x))
    k̂ = +ŷ; ϵ21 = ϕs[3]*rotate_pol(pol4_x, k̂); ϵ_func21 = ϵ_(ϵ21, 3); laser21 = Field(k̂, ϵ_func21, ω4, s_func(s4y))
    k̂ = -ŷ; ϵ22 = ϕs[4]*rotate_pol(pol4_x, k̂); ϵ_func22 = ϵ_(ϵ22, 4); laser22 = Field(k̂, ϵ_func22, ω4, s_func(s4y))
    k̂ = +ẑ; ϵ23 = ϕs[5]*rotate_pol(flip(pol4_x), k̂); ϵ_func23 = ϵ_(ϵ23, 5); laser23 = Field(k̂, ϵ_func23, ω4, s_func(s4z))
    k̂ = -ẑ; ϵ24 = ϕs[6]*rotate_pol(flip(pol4_x), k̂); ϵ_func24 = ϵ_(ϵ24, 6); laser24 = Field(k̂, ϵ_func24, ω4, s_func(s4z))
...
function simulate_particles_v3(package, params)
    ...
    if direction == "x"
         ...
         for i in 1:max_t_id
            ...
            for j in 1:length(results.x_velocities)
                if length(results.x_velocities[j]) >= i                                                                                                          push!(x_at_t, results.x_velocities[j][i])           
               end                                                                                                                    
            end                                                                                                                         
            push!(σs, std(x_at_t))
         end
     ...
     elseif direction == "y"
         ...
         for i in 1:max_t_id
            ...
            for j in 1:length(results.y_velocities)
                if length(results.y_velocities[j]) >= i                                                                                                          push!(x_at_t, results.y_velocities[j][i])           
               end                                                                                                                    
            end                                                                                                                         
            push!(σs, std(x_at_t))
         end
     ...
     elseif direction == "z"
         ...
         for i in 1:max_t_id
            ...
            for j in 1:length(results.z_velocities)
                if length(results.z_velocities[j]) >= i                                                                                                          push!(x_at_t, results.z_velocities[j][i])           
               end                                                                                                                    
            end                                                                                                                         
            push!(σs, std(x_at_t))
         end
