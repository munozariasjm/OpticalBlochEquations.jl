...
function simulate_particles_v3(package, params; variable_budget=false)
...
function plot_size(results, direction)
    ...
    if direction == "x"
     ...
     elseif direction == "all"
         ...
         plot(legend=true, title="centre position", xlabel="time (ms)",ylabel="position (mm)")
         plot!(plot_ts, σx, label="x")
         plot!(plot_ts, σy, label="y")
         plot!(plot_ts, σz, label="z")
         return plot_ts, σx, σy, σz
