...
export simulate_particles_constant_diffusion;
...
function continue_particle_constant_diffusion!(j, results, prob_copy)
    ...
    sol = DifferentialEquations.solve(prob_copy, alg=DP5(), reltol=1e-4, callback=cb, saveat=1000, maxiters=500000000)
#     sol = DifferentialEquations.solve(prob_copy, alg=Euler(), dt=1e-2, reltol=1e-3, callback=cb, saveat=4000, maxiters=50000000)
...
export continue_particle_constant_diffusion!            
...
export make_problem_with_param_constant_diffusion;                                